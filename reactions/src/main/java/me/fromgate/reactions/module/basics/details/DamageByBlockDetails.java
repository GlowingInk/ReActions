 ...
 */
public class DamageByBlockDetails extends DamageDetails {

    private final Block blockDamager;

    public DamageByBlockDetails(Player player, Block blockDamager, DamageCause cause, double damage, double finalDamage) {
