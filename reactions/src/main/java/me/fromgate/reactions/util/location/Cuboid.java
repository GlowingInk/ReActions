...
public class Cuboid {
    ...
    public Cuboid(Location loc1, Location loc2) {
        ...
        int[] pair;
        pair = MathUtils.sortedIntPair(loc1.getBlockX(), loc2.getBlockX());
        this.xMin = pair[0];
        this.xMax = pair[1];
        pair = MathUtils.sortedIntPair(loc1.getBlockZ(), loc2.getBlockZ());
        this.zMin = pair[0];
        this.zMax = pair[1];
        pair = MathUtils.sortedIntPair(loc1.getBlockY(), loc2.getBlockY());
        this.yMin = pair[0];
        this.yMax = pair[1];
    }
    ...
    public Cuboid(VirtualLocation loc1, VirtualLocation loc2) {
        ...
        int[] pair;
        pair = MathUtils.sortedIntPair(loc1.getX(0), loc2.getX(0));
        this.xMin = pair[0];
        this.xMax = pair[1];
        pair = MathUtils.sortedIntPair(loc1.getZ(0), loc2.getZ(0));
        this.zMin = pair[0];
        this.zMax = pair[1];
        if (loc1.getY() == null || loc2.getY() == null) {
            ...
            pair = MathUtils.sortedIntPair(loc1.getY(), loc2.getY());
            this.yMin = pair[0];
            this.yMax = pair[1];
        }
    }
