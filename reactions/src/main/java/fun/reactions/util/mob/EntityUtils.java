...
public final class EntityUtils {
    ...
    public static @NotNull Collection<@NotNull Entity> getEntities(@NotNull Location l1, @NotNull Location l2) {
        ...
        for (int xCh = xMin >> LocationUtils.CHUNK_BITS, xChMax = xMax >> LocationUtils.CHUNK_BITS; xCh <= xChMax; xCh++) {
            for (int zCh = zMin >> LocationUtils.CHUNK_BITS, zChMax = zMax >> LocationUtils.CHUNK_BITS; zCh <= zChMax; zCh++) {
