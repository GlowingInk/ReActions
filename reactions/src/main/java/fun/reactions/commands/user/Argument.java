...
public class Argument {
    ...
    public ExecType check(String arg) {
        return switch (type) {
            ...
            case INTEGER -> NumberUtils.IS_INTEGER.test(arg) ? ExecType.DEFAULT : ExecType.NOT_INTEGER;
            case FLOAT -> NumberUtils.IS_NUMBER.test(arg) ? ExecType.DEFAULT : ExecType.NOT_FLOAT;
