...
import fun.reactions.module.basics.activators.ButtonActivator;
...
public class ButtonContext extends ActivationContext {

    private final Location buttonLocation;

    public ButtonContext(Player p, Location loc) {
        super(p);
